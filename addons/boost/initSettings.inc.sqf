...
[   QGVAR(toleranceChange),"SLIDER",
    ["Tolerance Changed Target","How far can a new target be from the original target before the boost is stopped in metres"],[_categoryName,"Boost"],
    [1,100,5,0],true,{}
] call CBA_Settings_fnc_init;
